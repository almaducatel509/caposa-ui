...
interface MemberBulkActionDropdownProps {
  selectedCount: number;
  isOpen:        boolean;
  onToggle:      () => void;
  onAction:      (action: MemberBulkAction) => void;
}
...
const MemberBulkActionDropdown: React.FC<MemberBulkActionDropdownProps> = ({
...
export default MemberBulkActionDropdown;