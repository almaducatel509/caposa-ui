...
interface BranchBulkActionDropdownProps {
  selectedCount: number;
  isOpen:        boolean;
  onToggle:      () => void;
  onAction:      (action: BranchBulkAction) => void;
}
...
const BranchBulkActionDropdown: React.FC<BranchBulkActionDropdownProps> = ({
...
export default BranchBulkActionDropdown;