...
export default function WithdrawalStats({
  totalAmount, withdrawalCount, completedCount, avgAmount,
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3">
        ...
        <KPICard icon={TrendingUp}   label="Nombre de retraits" value={withdrawalCount} sub={`${completedCount} complétés`} accent={C.blue} />
