...
export default function DepositReceipt({ data, memberName, onReset }: Props) {
  ...
  const rows: Array<[string, React.ReactNode]> = [
    ...
    ['Source',      data.source],
    ['Montant',     <span className="font-bold text-[#2E7D32]">{formatHTG(data.montantTransaction)}</span>],
  ...
  // Lignes chèque uniquement si pertinent
