// app/dashboard/reports/portefeuille/page.tsx
import { Metadata } from "next";
import PageHeader from "@/app/components/header";
import { AlertTriangle } from "lucide-react";
import RapportPretsSouffrance from "@/app/components/reports/RapportPretsSouffrance";
import { KpiData } from "@/types/kpis";

export const metadata: Metadata = {
  title: "Rapport Qualité du Portefeuille | CAPOSA",
  description: "Analyse des prêts en souffrance et de la qualité du portefeuille",
};
  ...
  return (
    <main className="w-full bg-white">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <PageHeader
          title="Rapport Qualité du Portefeuille"
          subtitle="Analyse des prêts en souffrance et surveillance des risques"
          icon={<AlertTriangle className="text-4xl text-orange-600" />}
        />
      </div>
