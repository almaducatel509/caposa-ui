// app/dashboard/reports/liquidite/page.tsx
import { Metadata } from "next";
import PageHeader from "@/app/components/header";
import { Droplet } from "lucide-react";
import RapportLiquidite from "@/app/components/reports/RapportLiquidite";
import { KpiData } from "@/types/kpis";

export const metadata: Metadata = {
  title: "Rapport de Liquidité | CAPOSA",
...
export default function RapportLiquiditePage() {
    ...
    <main className="w-full bg-white">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <PageHeader
          ...
          subtitle="Analyse de la capacité à honorer les retraits immédiats"
          icon={<Droplet className="text-4xl text-cyan-600" />}
        />
      </div>
